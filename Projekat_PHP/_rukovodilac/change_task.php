...
<nav>
    ...
    <a href="view_tasks.php?group_id=<?php echo $group_id;?>">Nazad</a><br>
</nav>
<hr>

<h2>Izmeni zadatak:</h2>
<form action="change_task_logistics.php" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="user_id" value="<?php echo $rukovodilac_id?>">
